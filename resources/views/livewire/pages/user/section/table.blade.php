<div>
    ...
    <div class="space-y-2 mb-4">
        <div class="flex flex-col md:flex-row md:flex-nowrap md:items-center gap-2">
            ...
            <x-nawasara-ui::search-input model="search" placeholder="Cari username, email, atau nama..." />

            <div class="flex items-center gap-2 shrink-0">
                <x-nawasara-ui::icon-button icon="refresh-cw" tooltip="Sync ulang dari Keycloak" wire:click="refreshUsers" loadingTarget="refreshUsers" />
